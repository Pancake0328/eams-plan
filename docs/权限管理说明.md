...
员工：
- `system:employee:list` `system:employee:view` `system:employee:add`
- `system:employee:edit` `system:employee:delete` `system:employee:status`

资产分配：
- `system:asset-assign:list` `system:asset-assign:view`
- `system:asset-assign:assign` `system:asset-assign:return` `system:asset-assign:transfer`

### 5.3 资产管理
资产信息：
- `asset:info:list` `asset:info:view` `asset:info:add` `asset:info:edit`
- `asset:info:delete` `asset:info:status`
...
- `purchase:cancel` `purchase:pending-inbound`
- `purchase:inbound` `purchase:batch-inbound`

### 5.5 生命周期与盘点
生命周期：
- `lifecycle:list` `lifecycle:create`
- `lifecycle:history` `lifecycle:current` `lifecycle:change`
...
### 5.6 财务管理
- `finance:list`
- `finance:purchase:list` `finance:purchase:view` `finance:purchase:create`
- `finance:purchase:approve` `finance:purchase:delete`
