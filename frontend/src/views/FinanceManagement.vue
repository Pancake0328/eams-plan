<template>
  <div class="finance-page">
    <el-tabs v-model="activeTab" type="border-card">
        ...
        <el-card shadow="never">
          ...
          <el-table :data="purchaseList" v-loading="loading" border>
            ...
            <el-table-column label="操作" width="150" fixed="right">
              <template #default="{ row }">
                <el-button v-if="row.approvalStatus === 0" link type="primary" @click="handleApprove(row, true)">
                  通过
                </el-button>
                <el-button v-if="row.approvalStatus === 0" link type="danger" @click="handleApprove(row, false)">
                  拒绝
                </el-button>
      ...
      <el-tab-pane label="账单管理" name="bill">
        <el-card shadow="never">
          <div style="margin-bottom: 16px">
            ...
            />
            <el-button type="primary" @click="handleGenerateAnnualBill">生成年度账单</el-button>
          </div>
          ...
          <el-table :data="billList" v-loading="billLoading" border>
            ...
            <el-table-column label="操作" width="150" fixed="right">
              <template #default="{ row }">
                <el-button v-if="row.billStatus !== 2" link type="primary" @click="handleConfirmBill(row)">
                  确认
                </el-button>
      ...
      <!-- 资金统计 -->
      <el-tab-pane label="资金统计" name="statistics">
        <el-row :gutter="16">
          <el-col :span="24">
